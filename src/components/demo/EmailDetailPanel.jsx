  ...
  return (
    <div className="w-96 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        {/* AI References */}
        <div>
          <h4 className="text-sm font-semibold text-gray-700 mb-2">AI References</h4>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-medium text-blue-700">{ref.type}</span>
                    </div>
